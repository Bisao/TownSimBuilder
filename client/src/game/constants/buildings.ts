...
export const buildingTypes: Record<BuildingType, BuildingDefinition> = {
  market: {
    id: 'market',
    name: 'Mercado',
    description: 'Centro de comércio onde NPCs podem comprar e vender recursos',
  ...
  house: {
    id: 'house',
    name: 'Casa',
    description: 'Fornece abrigo para NPCs',
    cost: { wood: 5, stone: 2 },
    health: 100,
